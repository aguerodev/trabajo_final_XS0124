...
tabla <- df |>
  ...
  tab_stubhead(label = md("**Sexo declarado**")) |>
  tab_header(
    title = md("**Costa Rica: Estudiantes del curso Análisis Exploratorio de Datos de la carrera de Estadística de la Universidad de Costa Rica según sexo declarado, junio 2025**"
    ),
